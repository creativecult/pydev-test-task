# Django settings for testatask project.
...
SECRET_KEY = 'l4l=)-=r*-*sgzdbdu7dx9hvo0$gbig^=m3^uj4mnn#l1_qq*g'
...
MIDDLEWARE_CLASSES = (
    'middleware.QueriesCountMiddleware',
